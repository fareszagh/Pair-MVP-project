...
export default function MyOffers({ offers, loading, selectedOffer, onSelect, onDelete }) {
  ...
  return (
    <div className="panel">
      <h2 className="panel-title">My Offers
      ...
      {offers.length === 0 ? (
        <div className="empty-state">
          ...
          <p>No offers yet</p>
          <span>Click "New Offer" to get started</span>
        </div>
      ) : (
